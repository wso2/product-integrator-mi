...
public class QueryManager {
    private final Map<DBQueries, String> mysqlQueryMap =
            Collections.unmodifiableMap(new HashMap<DBQueries, String>() {{
                ...
                put(DBQueries.SELECT_MP_STATE_UPDATE_EVENT, "SELECT MP_NAME, MP_STATE FROM MP_STATE_TABLE");
                ...
                put(DBQueries.REMOVE_COORDINATOR_SELF, "DELETE FROM LEADER_STATUS_TABLE WHERE GROUP_ID =? AND NODE_ID =?");
                put(DBQueries.GET_NODE_ADVERTISEMENTS, "SELECT NODE_ID, HEARTBEAT_WINDOW, BOOT_ID FROM NODE_ADVERTISEMENT WHERE GROUP_ID =?");
                put(DBQueries.GET_NODE_ADVERTISEMENT, "SELECT HEARTBEAT_WINDOW, BOOT_ID FROM NODE_ADVERTISEMENT WHERE GROUP_ID =? AND NODE_ID =?");
                put(DBQueries.DELETE_NODE_ADVERTISEMENT_OF_BOOT, "DELETE FROM NODE_ADVERTISEMENT WHERE GROUP_ID =? AND NODE_ID =? AND BOOT_ID =?");
    ...
    public enum DBQueries {
        ...
        GET_NODE_DATA,
        DELETE_COORDINATOR,
        REMOVE_COORDINATOR_SELF,
        GET_NODE_ADVERTISEMENTS,
        GET_NODE_ADVERTISEMENT,
        DELETE_NODE_ADVERTISEMENT_OF_BOOT,
